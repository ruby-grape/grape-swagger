...
describe 'a simple mounted api' do
  before :all do
    ...
    class PrefixVersionTagApi < Grape::API
      version :v1
      namespace :hudson do
        desc 'Document root'
        get '/' do
  ...
  describe "retrieves swagger-documentation on /swagger_doc" do
    ...
    specify do
      expect(subject).to eq({
        ...
        "swagger"=>"2.0",
        "produces" => ["application/xml", "application/json", "application/octet-stream", "text/plain"],        "host"=>"example.org", 
        ...
        "paths"=>{
          ...
          "/api/v1/niles/custom"=>{"get"=>{"produces"=>["application/json"], "parameters"=>[{"in"=>"query", "name"=>"custom", "description"=>"array of items", "type"=>"CustomType", "required"=>false, "allowMultiple"=>true}], 
