  ...
  describe 'whole documentation' do
    ...
    describe 'swagger object' do
      describe 'required keys' do
        ...
        it { expect(subject.keys).to include 'components' }
        it { expect(subject['components']).to be_a Hash }
      end
      ...
      describe 'components object' do
        ...
        it { expect(components).to have_key('schemas') }
        it { expect(components['schemas']).to be_a Hash }
      end
