...
module GrapeSwagger
  module ModelBuilder
    # Builds ApiModel::Response objects from route response definitions.
    class ResponseBuilder
      ...
      def build_schema_from_hash(schema_hash)
        if schema_hash['$ref'] || schema_hash[:$ref]
          ...
          ApiModel::Schema.new(canonical_name: model_name)
          ...
          ApiModel::Schema.new(type: 'string', format: 'binary')
        else
