    ...
    it "includes headers" do
      ...
      JSON.parse(last_response.body)["apis"].should == [{
        ...
        "operations" => [{
          ...
          "httpMethod" => "GET",
          "parameters" => [
            { "paramType" => "header", "name" => "XAuthToken", "description" => "A required header.", "type" => "String", "required" => true, "defaultValue" => nil },
            { "paramType" => "header", "name" => "XOtherHeader", "description" => "An optional header.", "type" => "String", "required" => false, "defaultValue" => nil }
          ],
          "responseMessages" => [
    ...
    it "supports multiple parameters" do
      ...
      JSON.parse(last_response.body)["apis"].should == [{
        ...
        "operations" => [{
          ...
          "httpMethod" => "POST",
          "parameters" => [ { "paramType" => "form", "name" => "items[]", "description" => "array of items", "type" => "String", "required" => false, "defaultValue" => nil } ]
        }]
      }]
    end
    ...
    it "supports custom types" do
      ...
      JSON.parse(last_response.body)["apis"].should == [{
        ...
        "operations" => [{
          ...
          "httpMethod" => "GET",
          "parameters" => [ { "paramType" => "query", "name" => "custom", "description" => "array of items", "type" => "CustomType", "required" => false, "defaultValue" => nil } ]
        }]
      }]
    end
